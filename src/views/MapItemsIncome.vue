<template>
  <div id="maps-items-income-view" class="relative container mx-auto py-8">
    ...
    <map-details ref="mapDetails" :map="mapHistory.map" :character="poeSelectedCharacter" class="mb-4 opacity-0" />
...
export default class MapItemsIncomeView extends Vue {
  ...
  private animateAppearingComponents() {
    ...
    const mapIncomeTable = this.$refs.mapIncomeTable as HTMLDivElement;

    const targets = [mapDetailsComp.$el, mapIncomeTable];
